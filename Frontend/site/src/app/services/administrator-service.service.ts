...
export class AdministratorServiceService {
  ...
  getUsers(columns, order, search, offset, limit, page) { return this.http.post<any>(environment.api + '/user/list', { parameters: { columns: columns, order: order, search: search, offset: offset, limit: limit, page: page } }) }
