...
billinAddress = function (companyName, address, cp, city, country) {
  return {
    text: companyName + '\n' + address + '\n' + cp + ' ' + city + '\n' + country,
    style: 'invoiceBillingAddress'
  };
...
tabSum = function (serviceTotal, vatTotal, invoiceTotal, currency) {
...
priceCurrency = function (price, currency, txUsd, tx) {
