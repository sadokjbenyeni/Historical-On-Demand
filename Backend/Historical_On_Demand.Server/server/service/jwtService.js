...
module.exports.createTokentoUpdateUserMail = (user) => {
  return jwtManager.sign(user, global.environment.jwtMailCredentials.secret, global.environment.jwtMailCredentials.options);
};

module.exports.createTokentoResetPassword = (user) => {
  return jwtManager.sign(user, global.environment.jwtPasswordCredentials.secret, global.environment.jwtPasswordCredentials.options);
};